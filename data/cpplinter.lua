...
RELOAD_TYPE_MOVEMENTS = 8
RELOAD_TYPE_NPCS = 9
RELOAD_TYPE_QUESTS = 10
RELOAD_TYPE_SCRIPTS = 11
RELOAD_TYPE_SPELLS = 12
RELOAD_TYPE_TALKACTIONS = 13
RELOAD_TYPE_WEAPONS = 14
...
configKeys = {
	...
	SERVER_SAVE_NOTIFY_DURATION = 32,
	YELL_MINIMUM_LEVEL = 33,
	MINIMUM_LEVEL_TO_SEND_PRIVATE = 34,
	VIP_FREE_LIMIT = 35,
	VIP_PREMIUM_LIMIT = 36,
	DEPOT_FREE_LIMIT = 37,
