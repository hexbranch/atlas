...
* [Compiling](compiling/README.md) — guides for [Linux](compiling/linux.md), [Windows](compiling/windows-cmake.md) and [Docker](compiling/docker.md). Alternatively download [releases](https://github.com/otland/forgottenserver/releases).
